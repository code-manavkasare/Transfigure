...
import { loginUser,updateEmail,updatePassword,updateKey ,updateUuid,translateText} from '../actions/user'
...
reasons:[this.props.translateText("settingsDeleteAccount.concerned_data"),this.props.translateText("settingsDeleteAccount.trouble_getting_started"),this.props.translateText("settingsDeleteAccount.privacy_concern"),this.props.translateText("settingsDeleteAccount.receiving_unwanted_contact")]}
            ...
            <SafeAreaView style={styles.container}>
                <View style={{flex:1}}>
                    <View style={styles.upperPart}>
                        ...
                        <Text  style={{alignSelf:'center',fontSize:20,marginTop:'2%',color:'#f07c4a',fontWeight:'bold'}}>{this.props.translateText("settingsDeleteAccount.delete_account")}</Text>
                    </View>
                    <View style={{alignSelf:'center',alignItems:"center",marginTop:'2%',width:'90%',elevation:20,height:'75%',backgroundColor:'white',borderRadius:10}}>
                        ...
                        /> 
                        <TouchableOpacity style={{backgroundColor:'#ff4714',flexDirection:'row',
                        borderRadius:20,width:'60%',padding:8,justifyContent:'space-around',alignSelf:'center',marginTop:'3%'}} onPress={()=>{this.handleDelete()}}>
                            <Icon name='trash-2' type='feather' size={20} color='white' />
                            <Text style={{color:'white',marginLeft:'2%',fontWeight:'bold'}}>{this.props.translateText("settingsDeleteAccount.delete_account")}</Text>
                        </TouchableOpacity>
                    </View>
                </View>
...
const mapDispatchToProps = dispatch => {
    return bindActionCreators({ updateKey , loginUser,updateEmail,updatePassword,updateUuid,translateText}, dispatch)
}
