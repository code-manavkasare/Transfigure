...
class ReportReflection extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      deleteReason: "",
      reasons: [
        this.props.translateText("reportReflection.disrespectful_text"),
        this.props.translateText("reportReflection.directs_hate_race"),
        this.props.translateText("reportReflection.violence_text"),
        this.props.translateText("reportReflection.uncomfortable_text"),
        this.props.translateText("reportReflection.other_text"),
      ],
    };
  }
  componentDidMount() {}
  showAvatar() {
    ...
    if (this.state.avatarUri == "") {
      img = require("../images/profileimg1n.png");
    } else {
      img = this.state.avatarUri;
    }
    return (
      <Avatar
        size={50}
  ...
  async handleReport() {
    ...
    let resp = await reportReflection(
      this.props.user.authKey,
      this.props.route.params.reflectionID,
      reason
    );
    if (resp) {
      ...
      Alert.alert(
        this.props.translateText("reportReflection.failed_text"),
        this.props.translateText("reportReflection.something_wrong")
      );
    }
  }
  render() {
      ...
      <SafeAreaView style={styles.container}>
        <View style={{ flex: 1 }}>
          <View style={styles.upperPart}>
            ...
            >
              {this.props.translateText("reportReflection.report_reflection")}
            </Text>
          </View>
          <View
            style={{
          ...
          >
            ...
            >
              <RadioButton
                ...
                color="#3f32d2"
              />
              <Text style={{ fontSize: 15, flexWrap: "wrap", flex: 1 }}>
            ...
            >
              ...
              >
                {this.props.translateText("reportReflection.submit")}
              </Text>
            </TouchableOpacity>
          </View>
        </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(ReportReflection);
