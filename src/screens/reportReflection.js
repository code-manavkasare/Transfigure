...
class ReportReflection extends React.Component {
  constructor(props) {
    super(props);
...
reasons:[this.props.translateText("reportReflection.disrespectful_text"),this.props.translateText("reportReflection.directs_hate_race"),this.props.translateText("reportReflection.violence_text"),this.props.translateText("reportReflection.uncomfortable_text"),this.props.translateText("reportReflection.other_text")]}
...
async handleReport(){
    ...
    let resp =await reportReflection(this.props.user.authKey,this.props.route.params.reflectionID,reason)
    if(resp){
        this.props.navigation.navigate('ReportConfirmation',{type:'reflection'})
    }
    else{
        Alert.alert(this.props.translateText("reportReflection.failed_text"),this.props.translateText("reportReflection.something_wrong"))
    }
}
    render() {
        return (
            ...
            <SafeAreaView style={styles.container}>
                <View style={{flex:1}}>
                    <View style={styles.upperPart}>
                        ...
                        <Text  style={{alignSelf:'center',fontSize:18,marginTop:'2%',color:'#f07c4a',fontWeight:'bold'}}>{this.props.translateText("reportReflection.report_reflection")}</Text>
                    </View>
                    <View style={{alignSelf:'center',alignItems:"center",marginTop:'2%',width:'90%',elevation:20,height:'75%',backgroundColor:'white',borderRadius:10}}>
                        ...
                        >
                            {this.props.translateText("reportReflection.select_reason_text")}
                        </ParsedText>
                        <View style={{flexDirection:'row',alignItems:'center',justifyContent:'center',alignSelf:'flex-start'}}>
                            ...
                            color='#3f32d2'
                            />
                            <Text style={{fontSize:15, flexWrap: 'wrap',flex:1}}>{this.state.reasons[0]}</Text>
                        </View>
                        <View style={{flexDirection:'row',alignItems:'center',justifyContent:'center',alignSelf:'flex-start'}}>
                            <RadioButton
                            value={1}
                            ...
                            color='#3f32d2'
                            />
                            <Text style={{fontSize:15, flexWrap: 'wrap',flex:1}}>{this.state.reasons[1]}</Text>
                        </View>
                        <View style={{flexDirection:'row',alignItems:'center',justifyContent:'center',alignSelf:'flex-start'}}>
                            <RadioButton
                            value={2}
                            ...
                            color='#3f32d2'
                            />
                            <Text style={{fontSize:15, flexWrap: 'wrap',flex:1}}>{this.state.reasons[2]}</Text>
                        </View>
                        <View style={{flexDirection:'row',alignItems:'center',justifyContent:'center',alignSelf:'flex-start'}}>
                            <RadioButton
                            value={3}
                            ...
                            color='#3f32d2'
                            />
                            <Text style={{fontSize:15, flexWrap: 'wrap',flex:1}}>{this.state.reasons[3]}</Text>
                        </View>
                        <View style={{flexDirection:'row',alignItems:'center',justifyContent:'center',alignSelf:'flex-start'}}>
                            <RadioButton
                            value={4}
                        ...
                        <TextInput
                        placeholder={this.props.translateText("settingsDeleteAccount.delete_reason_text")}
                        ...
                        borderRadius:20,width:'60%',padding:8,justifyContent:'center',alignSelf:'center',marginTop:'3%'}}>
                            ...
                            <Text style={{color:'white',marginLeft:'2%',fontWeight:'bold'}}>{this.props.translateText("reportReflection.submit")}</Text>
                        </TouchableOpacity>
                    </View>
                </View>
