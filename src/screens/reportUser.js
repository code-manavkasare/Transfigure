...
class ReportUser extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      deleteReason: "",
      reasons: [
        this.props.translateText("report.inappropriate_profile"),
        this.props.translateText("report.bullying"),
        this.props.translateText("report.harassment"),
        this.props.translateText("report.fake_user"),
