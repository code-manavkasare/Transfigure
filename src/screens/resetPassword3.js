  ...
  async resetPassword() {
    ...
    if (
      ...
      if (resp) {
        Alert.alert(
          "Success!",
          this.props.translateText("reset.success_password")
        );
      ...
      if (this.state.password != this.state.confPassword) {
        this.setState({
          alertText: this.props.translateText("reset.confirm_password"),
        });
      }
      if (this.state.password.length < 8) {
        this.setState({
          alertText: this.props.translateText("reset.password_must_have"),
        });
      }
    }
  }
        ...
        <SafeAreaView style={styles.container}>
          ...
          <View style={styles.iconStyle}>
            ...
            <Text style={{ color: "white", fontSize: 20 }}>
              {this.props.translateText("reset.reset_your_password")}
            </Text>
            <Text style={{ color: "white", fontSize: 16 }}>
              {this.props.translateText("reset.set_your_new_password")}
            </Text>
          </View>
          <View style={styles.inputBox}>
            ...
            <Input
              placeholder={this.props.translateText(
                "reset.confirm_new_password"
              )}
              leftIcon={{
                type: "entypo",
                name: "user",
                onPress: () => {
                  this.setState({ confpassVis: !this.state.confpassVis });
                },
              }}
          ...
          >
            <Text style={{ color: "white", fontSize: 25 }}>
              {this.props.translateText("reset.reset")}
            </Text>
          </TouchableOpacity>
        </SafeAreaView>
      </TouchableWithoutFeedback>
...
export default connect(mapStateToProps, mapDispatchToProps)(ResetPassword3);
