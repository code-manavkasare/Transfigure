...
async checkCode(){
    ...
    if(resp){
        this.props.navigation.navigate('ResetPassword3',{email:this.props.route.params.email})
    }
...
<TouchableWithoutFeedback onPress={()=>{Keyboard.dismiss()}}>
            <SafeAreaView style={styles.container}>
                ...
                <View style={styles.iconStyle}>
                    ...
                    <Text style={{color:'white',fontSize:20}}>{this.props.translateText("reset.enter_verification_code")}</Text>
                    <Text style={{color:'white',fontSize:16}}>{this.props.translateText("reset.please_enter_verification_code")}</Text>
                    <Text style={{color:'white',fontSize:16}}>{this.props.translateText("reset.that_was_sent")} </Text>
                </View>
                <View style={styles.inputBox}>
                        <Input
                        placeholder={this.props.translateText("reset.enter_verification_code_placeholder")}
                ...
                <TouchableOpacity  style={styles.buttonLogin} onPress={()=>{this.checkCode() }}>
                            <Text style={{color:'white',fontSize:25}}>{this.props.translateText("reset.confirm")}</Text>
                </TouchableOpacity>   
