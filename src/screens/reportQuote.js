...
reasons:[this.props.translateText("report.its_disrespectful"), this.props.translateText("report.its_direct_hate"), this.props.translateText("report.threatening_violence"), this.props.translateText("report.person_might_contemplating"), this.props.translateText("report.other")]}
...
async handleReport(){
    ...
    let resp =await reportQuote(this.props.user.authKey,this.props.route.params.quoteID,reason)
    if(resp){
        this.props.navigation.navigate('ReportConfirmation',{type:'quote'})
    }
    else{
            ...
            <SafeAreaView style={styles.container}>
                <View style={{flex:1}}>
                    <View style={styles.upperPart}>
                        ...
                        <Text  style={{alignSelf:'center',fontSize:18,marginTop:'2%',color:'#f07c4a',fontWeight:'bold'}}>{this.props.translateText("report.report_quote")}</Text>
                    </View>
                    <View style={{alignSelf:'center',alignItems:"center",marginTop:'2%',width:'90%',elevation:20,height:'75%',backgroundColor:'white',borderRadius:10}}>
                        ...
                        >
                            {this.props.translateText("report.repoting_this_quote")}
                        </ParsedText>
                        ...
                        <View style={{flexDirection:'row',alignItems:'center',justifyContent:'center',alignSelf:'flex-start'}}>
                            ...
                            color='#3f32d2'
                            />
                            <Text style={{fontSize:15, flexWrap: 'wrap',flex:1}}>{this.state.reasons[4]}</Text>
                        </View>
