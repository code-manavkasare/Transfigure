...
class ResetPassword1 extends React.Component {
  ...
  async handleSendCode() {
    ...
    resp = true;
    if (resp) {
      this.props.navigation.navigate("ResetPassword2", {
        ...
        <SafeAreaView style={styles.container}>
          ...
          <View style={styles.iconStyle}>
            ...
            <Text style={{ color: "white", fontSize: 20 }}>
              {this.props.translateText("reset.enter_your_email")}
            </Text>
            <Text style={{ color: "white", fontSize: 16 }}>
              {this.props.translateText("reset.email_verification_code")}{" "}
            </Text>
            <Text style={{ color: "white", fontSize: 16 }}>
              {this.props.translateText("reset.sent_to_your_email")}
            </Text>
          </View>
          ...
          >
            <Text style={{ color: "white", fontSize: 25 }}>
              {this.props.translateText("reset.send_code")}
            </Text>
          </TouchableOpacity>
...
const mapDispatchToProps = (dispatch) => {
  return bindActionCreators(
    { loginUser, updateEmail, updatePassword, translateText },
    dispatch
  );
};
