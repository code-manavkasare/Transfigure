  ...
  async handleLogin() {
    ...
    if (resp.success) {
      ...
      if (resp.reason == 1) {
        Alert.alert(
          "Login failed",
          this.props.translateText("login.wrong_password")
        );
      }
      if (resp.reason == 0) {
        Alert.alert(
          "Login failed",
          this.props.translateText("login.email_auth")
        );
      }
    }
  }
      ...
      >
        <SafeAreaView style={styles.container}>
          <View style={styles.circle}>
            <Text style={{ color: "white", fontSize: 30, marginTop: "2%" }}>
            ...
            <Text style={{ color: "white", fontSize: 20 }}>
              {this.props.translateText("login.welcome")}
            </Text>
            <Text style={{ color: "white", fontSize: 16, fontStyle: "italic" }}>
              {this.props.translateText("login.please_login")}
            </Text>
          </View>
          <View style={styles.inputBox}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                this.props.navigation.navigate("ResetPassword1");
              }}
            >
              <Text style={{ color: "orange", fontSize: 17 }}>
                {this.props.translateText("login.forgot_password")}?
              </Text>
            </TouchableOpacity>
          </View>
          ...
          >
            <Text style={{ color: "white", fontSize: 25 }}>
              {this.props.translateText("login.login")}
            </Text>
          </TouchableOpacity>
          <View
          ...
          >
            <Text style={{ color: "black", fontSize: 15 }}>
              {this.props.translateText("login.dont_have_account")}?
            </Text>
            <TouchableOpacity
              style={{
            ...
            >
              <Text style={{ color: "white", fontSize: 25 }}>
                {this.props.translateText("login.signup")}
              </Text>
            </TouchableOpacity>
          </View>
        </SafeAreaView>
