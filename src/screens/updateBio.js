...
class UpdateBio extends React.Component {
  ...
  showAvatar() {
    if (this.state.avatarUri == "" || this.state.avatarURI == false) {
      ...
      return (
        <Avatar
          size={parseInt(Dimensions.get("window").height * 0.1)}
          source={img}
          showAccessory
          rounded
          onPress={() => {
        ...
        <SafeAreaView style={styles.container}>
          <View style={{ flex: 1 }}>
            ...
            <View style={styles.upperPart}>
              ...
              >
                {this.props.translateText("updateBio.mybio")}
              </Text>
            </View>
            <View style={{ width: "100%" }}>
              ...
              >
                ...
                >
                  {this.props.translateText("updateBio.display_name")}
                </Text>
                <Input
                  placeholder={this.props.translateText(
                    "updateBio.display_name"
                  )}
                ...
                >
                  {this.props.translateText("updateBio.display_title")}
                </Text>
                <Input
                  placeholder={this.props.translateText(
                    "updateBio.display_title"
                  )}
                  leftIcon={{ type: "font-awesome-5", name: "toolbox" }}
                  value={this.state.displayTitle}
                  onChangeText={(value) =>
                    this.setState({ displayTitle: value })
                  }
                  inputContainerStyle={{
                    borderWidth: 2,
                    marginTop: "2%",
                ...
                >
                  {this.props.translateText("updateBio.your_biography")}
                </Text>
                <View
                  style={{
                    borderWidth: 2,
                ...
                >
                  ...
                  >
                    {this.props.translateText("updateBio.update")}
                  </Text>
                </TouchableOpacity>
              </View>
            </View>
